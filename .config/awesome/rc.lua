...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "i", function () awful.client.focus.byidx(-1) end, {description = "focus previous by index", group = "client"} ),

    -- Layout manipulation
    awful.key({ modkey, "Shift"   }, "e", function () awful.client.swap.byidx(  1)    end, {description = "swap with next client by index", group = "client"}),
    awful.key({ modkey, "Shift"   }, "i", function () awful.client.swap.byidx( -1)    end, {description = "swap with previous client by index", group = "client"}),
    awful.key({ modkey, "Control" }, "e", function () awful.screen.focus_relative( 1) end, {description = "focus the next screen", group = "screen"}),
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "h", function (c) c.minimized = true end , {description = "minimize", group = "client"}),
