{ inputs, self, ... }:
{
  ...
  flake.nixosModules.selbeiskamiModule =
    { pkgs, ... }:
    {
  ...
  flake.nixosModules.selbeiskamiHardwareModule = # Do not modify this file!  It was generated by ‘nixos-generate-config’
...

    {
      ...
      fileSystems."/" = {
        device = "/dev/disk/by-uuid/025b50db-f343-4bb4-9f4b-4ef9a7cae8f4";
        fsType = "ext4";
      };

      fileSystems."/boot" = {
        device = "/dev/disk/by-uuid/9B67-B99D";
        fsType = "vfat";
        options = [
          "fmask=0077"
          "dmask=0077"
      ...
      swapDevices = [
        { device = "/dev/disk/by-uuid/79e0ec19-d22e-4165-a822-3607c0ee1d98"; }
      ];
